        ...
        <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Login</p>
          ...
          <form class="mx-1 mx-md-4" method="post">
            ...
            <div class="form-outline mb-4">
              <input type="email" id="form2Example1" name="email" required class="form-control" placeholder="Email address">
            </div>

            <!-- Password input -->
            <div class="form-outline mb-4">
              <input type="password" id="form2Example2" name="pwd" required class="form-control" placeholder="Password">
            </div>
